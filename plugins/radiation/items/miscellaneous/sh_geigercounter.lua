...
ITEM.description = "Персональный счетчик Гейгера, измеряющий местный уровень радиации."
ITEM.longdesc = "Используемый для обнаружения и измерения ионизирующего излучения, он широко используется в таких областях, как радиационная дозиметрия, радиологическая защита, экспериментальная физикаи ядерная промышленность."
