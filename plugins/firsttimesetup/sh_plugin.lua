...
PLUGIN.description = "Плагин, который позволяет вам создавать предустановленные карты контейнеров и расширенных поставщиков и устанавливать начальные данные плагина."
