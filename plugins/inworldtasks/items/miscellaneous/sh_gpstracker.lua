ITEM.name = "GPS трекер"
ITEM.description = "Небольшой датчик, который отслеживает собственное положение. Перемещение на север увеличит вашу Широту, а перемещение на Восток увеличит вашу Долготу."
