...
function PLUGIN:PopulateHelpMenu(tabs)
    tabs["ПОМОЩЬ"] = function(container)
        local title = container:Add("DLabel")
        title:SetText("Добро пожаловать на сервер ASPIRATION project!")
        title:SetFont("def_pozi_42")
        title:Dock(TOP)
        title:InvalidateLayout(true)
        title:SetAutoStretchVertical(true)
        local wip = container:Add("DLabel")
        wip:SetFont("def_pozi_16")
        wip:SetText("Сервер находится в разработке, все, что вы видите, находится в разработке!")
        wip:Dock(TOP)
        wip:SetAutoStretchVertical(true)
        local lore = container:Add("DLabel")
        lore:SetWrap(true)
        lore:SetFont("def_pozi_26")
