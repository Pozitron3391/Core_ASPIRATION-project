...
function ix.util.DrawStatusIcon(iconstring, value, posX, posY, padding)
    ...
    --нарисуйте фон круга и раскрасьте его соответствующим образом
    surface.SetMaterial(background)
    if value > 90 then
        surface.SetDrawColor(Color(0, 0, 0, 0))
    elseif value > 70 then
        surface.SetDrawColor(Color(100, 255, 50))
    elseif value > 50 then
        surface.SetDrawColor(Color(215, 255, 55))
    elseif value > 30 then
        surface.SetDrawColor(Color(255, 255, 0))
    elseif value > 10 then
        surface.SetDrawColor(Color(255, 70, 30))
    elseif value <= 10 then
